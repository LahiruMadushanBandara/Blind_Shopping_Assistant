...
public final class Constants {
    ...
    public static final String REGION_NAME_PREFIX = "com.beacon.shopping.assistant";
    //actions
    public static final String NOTIFY_BEACON_ENTERS_REGION = "com.beacon.shopping.assistant.action.NOTIFY_BEACON_ENTERS_REGION";
    public static final String NOTIFY_BEACON_LEAVES_REGION = "com.beacon.shopping.assistant.action.NOTIFY_BEACON_LEAVES_REGION";
    public static final String NOTIFY_BEACON_NEAR_YOU_REGION = "com.beacon.shopping.assistant.action.NOTIFY_BEACON_NEAR_YOU_REGION";

    public static final String ALARM_NOTIFICATION_SHOW = "com.beacon.shopping.assistant.action.ALARM_NOTIFICATION_SHOW";
    public static final String GET_CURRENT_LOCATION = "com.beacon.shopping.assistant.action.GET_CURRENT_LOCATION";
